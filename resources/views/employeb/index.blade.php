...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tables des employé du bureau</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row">
               ...
               <p>ajouter employé du bureau</p>             <a  class="btn btn-primary" type="button"  data-toggle="modal" data-target=".bs-example-modal-lg"><b class="glyphicon glyphicon-plus"></b></a>
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                ...
                                @foreach($employeb as $emp)
                                <?php  $id=$emp->id_emp; 
                                $id_bureu=$emp->id_bureau;
                                 $employee=App\employee::find($id);
                            $bureau=App\bureau::find($id_bureu);
                            $id_b=$bureau->id_agence;
                            $agence=App\agence::find($id_b);
                            
                                  ?>
    <tr > 
        <td>{!!$employee->nom_emp !!}  {!!$employee->prenom_emp !!}</td>
            <td>{!!  $bureau->libelle_bureau !!}</td>
                <td>{!!  $emp->fonctionalite !!}</td>
                    <td>{!!  $emp->echelle !!}</td>
                    <td>{!! $agence->libelle_agc !!}</td>
                    <td>{!! $agence->adresse_agc !!}</td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
   ...
   Voulez Vous supprimez  cet employé de bureau?
      </div>
